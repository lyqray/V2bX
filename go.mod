...
// 更新 hysteria 版本
replace github.com/apernet/hysteria/core/v2 => github.com/apernet/hysteria/core/v2 v2.8.2

replace github.com/apernet/hysteria/extras/v2 => github.com/apernet/hysteria/extras/v2 v2.8.2
